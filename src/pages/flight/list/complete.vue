<template>
	<div class="detail">
		<div class="header">
			...
			<p class="title">即将带你进入海航</p>
		</div>
		<div class="list-item">
			<div class="order-content">
				<ul class="order-list">
					<li>
						<span class="order-title">广州-北京</span>
						<span class="order-info">
							<u>HU7324</u>
						</span>
					</li>
					<li>
						<span class="order-title">出发日期</span>
						<span class="order-info">
							<u>2018-07-03</u>
						</span>
					</li>
					<li>
						<span class="order-title">海航</span>
						<span class="order-info">
							<em>￥987</em>
						</span>
					</li>
					<li>
						<span class="order-title">佳乐比旅行</span>
						<span class="order-info">
							<b>始终</b><em>￥0</em>
						</span>
					</li>
		...
		<ul class="list-info">
			...
			<li class="a-loading">
				<span class="reach">即将带你进入海航</span>
